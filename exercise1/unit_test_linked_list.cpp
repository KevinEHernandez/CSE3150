...
TEST_CASE("linked_list testing") {
    ...
    {
        struct node * delete_linked_list_one_elt = build_new_linked_list(one_element_linked_list);

         CHECK_EQ(get_linked_list_data_item_value( 
            delete_linked_list_one_elt,
            one_element_linked_list,
            one_element_linked_list), 
            data_value_of_initial_linked_list_elt); // make

        delete_linked_list(delete_linked_list_one_elt); //delete

        CHECK_NE(get_linked_list_data_item_value( 
            delete_linked_list_one_elt,
            one_element_linked_list,
            one_element_linked_list), 
            data_value_of_initial_linked_list_elt); //check again, not equal, indicating the list got nuked
